...
<input type="search" name="passs" id="searc-basic" placeholder="search facebook" value="" style="margin-top: 9px;width: 65%;margin-bottom: 9px ;width: 80%; margin-left: 0px">
...
<label style="margin-top:5px;color: white">LisinaLIz</label></div>
           </div></div></div></header>
<div class="container_fluid">
    <div style="background: #e6eaf2">
        <div class="row">
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;
          <img src="images/imag.jpg" height="30"  style="margin-right: 20px" width="35">
          <label style="font-size: 14px"> LisinaLiz </label>
          <br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/down.jpg" height="30"  style="margin-right: 20px" width="35">
           ...
           <div class="col-md-8"  >
             <div class="container" style="background: white; margin-top: 11px;width: 100%;height: 189px;">
               ...
               <div class="container" style="background: white;width: 670px;max-width: 100%;height: 229px;"></div></div>
                <div class="col-md-2"  >
                <div class="container" style="background: white; margin-top: 12px;
